...
function page() {
  ...
  for (const file of ['figures.js', 'lesson-lab.js', 'games.js', 'teacher-flow.js', 'views.js', 'data-loader.js', 'class-dashboard.js','exam-analysis.js','practice-workspace.js','app.js']) {
