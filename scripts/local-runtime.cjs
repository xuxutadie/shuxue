...
async function main(){
 ...
 if(process.argv[2]==='test')execFileSync(process.execPath,['--test','tests/online.test.cjs','tests/preparation.test.cjs','tests/course-videos.test.cjs','tests/teacher-flow.test.cjs','tests/navigation.test.cjs','tests/practice-alignment.test.cjs','tests/ai-practice.test.cjs','tests/ai-ui.test.cjs','tests/exam-analysis.test.cjs','tests/homework.test.cjs','tests/homework-ui.test.cjs','tests/factor-game.test.cjs','tests/world3d.test.cjs','tests/world3d-sync.test.cjs','tests/world3d-assets.test.cjs','tests/playground.test.cjs'],{cwd:root,env:process.env,stdio:'inherit',windowsHide:true});
