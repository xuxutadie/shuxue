...
globalThis.ThinkingTown=(()=>{
  ...
  function mount(root,data,options={}){
    ...
    import('/world3d/town3d.js?v=20260922-valley1').then(module=>{if(!abandoned)stop=module.mountWorld(root,data,speak,options);}).catch(()=>{if(!abandoned){const box=root.querySelector('#town-loading');if(box)box.innerHTML='<strong>3D组件未能加载</strong><p>请刷新页面重试，或从下方学习路线继续练习。</p>';}});
