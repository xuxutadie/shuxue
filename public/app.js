...
function shell(){
 ...
 const nav=teacher?[['home','⌂','班级工作台'],['courses','▤','课程与教案'],['exams','✎','学生测评'],['ai-practice','✦','AI 引导练习'],['report','▥','学生成长档案'],['teacher','⚙','班级与资源']]:[['home','⌂','我的探索基地'],['courses','⚑','六周探险地图'],['games','◇','思维游乐场'],['practice','✓','练习与错题'],['report','▥','我的成长足迹']];
...
async function render(options={}){
 ...
 try{
  ...
  if(!teacher&&route==='practice'&&['work','ai','wrong','exams'].includes(parts[1]))practiceTab=parts[1];
